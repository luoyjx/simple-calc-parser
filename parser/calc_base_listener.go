...
// EnterManulDiv is called when production ManulDiv is entered.
func (s *BaseCalcListener) EnterManulDiv(ctx *ManulDivContext) {}

// ExitManulDiv is called when production ManulDiv is exited.
func (s *BaseCalcListener) ExitManulDiv(ctx *ManulDivContext) {}
